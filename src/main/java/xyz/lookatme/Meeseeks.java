...
@NamedQueries(value = {
        @NamedQuery(name = "Meeseeks.findAll", query = " SELECT o FROM Meeseeks o ")

})


@NamedNativeQueries(value = {
        @NamedNativeQuery(name = "Meeseeks.Native.findAll", query = " SELECT * FROM Meeseeks ORDER BY id ")
})
...
public class
Meeseeks extends PanacheEntityBase implements Serializable {
    @Serial
    ...
    public Meeseeks(UUID id, UUID uid, Integer val, Boolean enabled, OffsetDateTime createdOn, OffsetDateTime modifiedOn) {
        this.id = id;
        this.uid = uid;
        this.val = val;
